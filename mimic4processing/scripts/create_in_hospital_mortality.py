...
def main():
    ...
    parser.add_argument('output_path', default='/home/leew/mimic4processed/in-hospital-mortality/', type=str, help="Directory where the created data should be stored.")
